...
cp $SRC/javax.el-3.0.0.20161229.jar $REPO/javax.el/javax.el-3.0.0.jar
...
cp $SRC/javax.security.auth.message-1.1.0.20161229.jar $REPO/javax.security.auth.message/javax.security.auth.message-1.1.0.jar
cp $SRC/javax.servlet-3.1.0.20161229.jar $REPO/javax.servlet/javax.servlet-3.1.0.jar
cp $SRC/javax.servlet.jsp-2.3.0.20161229.jar $REPO/javax.servlet.jsp/javax.servlet.jsp-2.3.0.jar
...
cp $SRC/javax.websocket_1.1.0.20161229.jar $REPO/javax.websocket/javax.websocket_1.1.0.jar
